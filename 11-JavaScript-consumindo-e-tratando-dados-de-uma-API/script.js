...
async function buscarEMostrarVideos() {
    ...
    const videos = await busca.json();
        ...
        videos.forEach((video)=> {
            if(video.categoria =="") { // para criar erros personalizados para os erros aparecerem
...
const botaoCategoria = documento.querySelectorAll(".superior__item");
